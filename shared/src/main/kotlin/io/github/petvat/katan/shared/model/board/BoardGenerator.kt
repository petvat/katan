...
object BoardGenerator {
    ...
    fun generateBoard(settings: Settings): Board {
        ...
        // Create Tile for each coordinate
        val tiles: MutableList<Tile> = mutableListOf()
        val numbers = mutableListOf<Int>()
        numbers.addAll(settings.terrainNumbers)
        numbers.shuffle()
    ...
    /**
     * Select a random tile out of the remaining tiles from terrainCount
     */
...
//import io.github.petvat.katan.Resource
...
//
//    fun generateBoard() {
//        // With Custom gameState settings.
//        // Random, tile counts
//    }
//
//
